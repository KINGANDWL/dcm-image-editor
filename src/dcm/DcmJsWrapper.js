...
exports.DcmJsWrapper = void 0;
const VR_enum_1 = require("./VR.enum");
...
class DcmJsWrapper {
     ...
     */
    getPixelLength() {
        return this._dictionary.dict["7FE00010"].Value[0].byteLength / 2;
    }
    /**
     * 获取16位像素数组
     */
    getPixelUint16Array() {
        return new Uint16Array(this._dictionary.dict["7FE00010"].Value[0]);
    }
    /**
     * 获取8位像素数组
     */
    getPixelUint8Array() {
        return new Uint8Array(this._dictionary.dict["7FE00010"].Value[0]);
    }
    /**
     ...
     * @param Columns 分辨率列
     */
    setPixel(arr, Rows, Columns) {
        let size = { Rows: 0, Columns: 0 };
        let buffer = new Uint8Array(arr.buffer); //8位存储
...
DcmJsWrapper.DcmTemplate = {
    meta() {
        return {
            '00020001': { vr: VR_enum_1.VR_ENUM.OB, Value: [Uint8Array.from([0, 1]).buffer] },
            '00020002': { vr: VR_enum_1.VR_ENUM.UI, Value: ['1.2.276.0.7230010.3.1.0.1'] },
            '00020003': { vr: VR_enum_1.VR_ENUM.UI, Value: ['1.2.276.0.7230010.3.1.4.4042681065.1160.1529291001.400'] },
            '00020010': { vr: VR_enum_1.VR_ENUM.UI, Value: ['1.2.840.10008.1.2.1'] },
            '00020012': { vr: VR_enum_1.VR_ENUM.UI, Value: ['1.2.276.0.7230010.3.0.3.6.2'] },
            '00020013': { vr: VR_enum_1.VR_ENUM.SH, Value: ['OFFIS_DCMTK_362'] }
        };
    },
    dict() {
        return {
            '00080008': { vr: VR_enum_1.VR_ENUM.CS, Value: ['ORIGINAL', 'PRIMARY'] },
            '00080060': { vr: VR_enum_1.VR_ENUM.CS, Value: ['OT'] },
            '00080080': { vr: VR_enum_1.VR_ENUM.LO, Value: [''] },
            '00100010': { vr: VR_enum_1.VR_ENUM.PN, Value: ['none'] },
            '00200011': { vr: VR_enum_1.VR_ENUM.IS, Value: [1] },
            '00200013': { vr: VR_enum_1.VR_ENUM.IS, Value: [1] },
            '00280002': { vr: VR_enum_1.VR_ENUM.US, Value: [1] },
            '00280004': { vr: VR_enum_1.VR_ENUM.CS, Value: ['MONOCHROME2'] },
            '00280006': { vr: VR_enum_1.VR_ENUM.US, Value: [0] },
            '00280008': { vr: VR_enum_1.VR_ENUM.IS, Value: [1] },
            '00280010': { vr: VR_enum_1.VR_ENUM.US, Value: [0] }, //高度
            '00280011': { vr: VR_enum_1.VR_ENUM.US, Value: [0] }, //宽度
            '00280100': { vr: VR_enum_1.VR_ENUM.US, Value: [16] },
            '00280101': { vr: VR_enum_1.VR_ENUM.US, Value: [16] },
            '00280102': { vr: VR_enum_1.VR_ENUM.US, Value: [15] },
            '00280103': { vr: VR_enum_1.VR_ENUM.US, Value: [0] },
            '00281052': { vr: VR_enum_1.VR_ENUM.DS, Value: [0] },
            '00281053': { vr: VR_enum_1.VR_ENUM.DS, Value: [1] },
            '7FE00010': {
                vr: VR_enum_1.VR_ENUM.OB, Value: [
